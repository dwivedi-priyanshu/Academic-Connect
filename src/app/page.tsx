          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
                    Welcome to Academic Connect
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Your integrated platform for seamless academic management. Connect, collaborate, and achieve excellence.
                  </p>
                </div>
              ...
              <Image
                ...
                height="550"
                src="https://picsum.photos/seed/academic-hero/550/550"
                ...
                <Card key={feature.title} className="shadow-md hover:shadow-lg transition-shadow">
                  <CardHeader className="pb-4">
                    <div className="flex items-center gap-3">
                      <span className="p-2 bg-primary/10 rounded-md text-primary">{feature.icon}</span>
...
// Helper components for icons (could be moved to a separate file)
