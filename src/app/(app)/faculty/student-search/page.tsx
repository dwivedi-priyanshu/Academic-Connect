...
export default function StudentSearchPage() { 
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold flex items-center"><UserSearch className="mr-2 h-8 w-8 text-primary" /> Student Search</h1>
                    ...
                    <TableRow key={student.userId}>
                      ...
                      <TableCell className="text-right">
                        <Button asChild variant="outline" size="sm">
                          {/* Ensure this link points to the new student search profile page */}
                          <Link href={`/faculty/student-search/${student.userId}/profile`}> 
